            ...
            <b-card header="Новая заявка" class="w-100">
                ...
                <b-row class="wrap__create_req__card">
                    ...
                    <div class="wrap__create_req__container__buttons mt-3">
                        ...
                        <b-button class="m-3" v-b-modal.deleteRequest style="background-color: #E84242; border:none;">Удалить</b-button>
                    </div>
                    ...
                    <b-modal size="lg" v-model="modalShow" centered style="text-align: center;">
                        ...
                        <div class="wrap__objects__element__container__modal__text text-center">
                            ...
                            <u style="cursor: pointer;" @click="$router.push('/admin/requests/requests')">Вернуться к списку заявок</u><br><br>
